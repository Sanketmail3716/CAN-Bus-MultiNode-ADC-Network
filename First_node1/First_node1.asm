...
L_main0:
;First_node1.c,54 :: 		adc_value = ADC_Read(0); // 10-bit ADC
	...
	MOVF       R0+1, 0
	MOVWF      _adc_value+1
;First_node1.c,56 :: 		RxTx_Data[0] = adc_value >> 8;     // MSB
	MOVF       R0+1, 0
	MOVWF      R2+0
	CLRF       R2+1
	MOVF       R2+0, 0
	MOVWF      _RxTx_Data+0
;First_node1.c,57 :: 		RxTx_Data[1] = adc_value & 0xFF;   // LSB
	MOVLW      255
	ANDWF      R0+0, 0
	MOVWF      _RxTx_Data+1
;First_node1.c,58 :: 		Lcd_Out(2,1,"TXD:");
	MOVLW      2
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      1
	MOVWF      FARG_Lcd_Out_column+0
	...
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;First_node1.c,59 :: 		Lcd_Cmd(0xC6);
	MOVLW      198
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;First_node1.c,60 :: 		Lcd_Chr_Cp(adc_value/1000+'0');
	MOVLW      232
	MOVWF      R4+0
	MOVLW      3
	MOVWF      R4+1
	...
	CALL       _Lcd_Chr_CP+0
;First_node1.c,61 :: 		Lcd_Chr_Cp(((adc_value/100)%10)+'0');
	MOVLW      100
	MOVWF      R4+0
	MOVLW      0
	MOVWF      R4+1
	...
	MOVWF      FARG_Lcd_Chr_CP_out_char+0
	CALL       _Lcd_Chr_CP+0
;First_node1.c,62 :: 		Lcd_Chr_Cp(((adc_value/10)%10)+'0');
	MOVLW      10
	MOVWF      R4+0
	MOVLW      0
	MOVWF      R4+1
	...
	MOVWF      FARG_Lcd_Chr_CP_out_char+0
	CALL       _Lcd_Chr_CP+0
;First_node1.c,63 :: 		Lcd_Chr_Cp((adc_value%10)+'0');
	MOVLW      10
	MOVWF      R4+0
	MOVLW      0
	MOVWF      R4+1
...
;First_node1.c,64 :: 		Lcd_Out(1,11,"     ");
	...
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;First_node1.c,67 :: 		CANSPIWrite(ID_1st, RxTx_Data, 2, Can_Send_Flags);
	MOVLW      79
