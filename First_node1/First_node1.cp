#line 1 "G:/My Drive/Envision/PIC Microcontroller/MikroC/Three_Node_PIC16/First_node1/First_node1.c"
...
char RxTx_Data[8];
char Msg_Rcvd;
const long ID_1st = 12111, ID_2nd = 2 ,ID_3rd = 3;
long Rx_ID;
...
void main() {
 ...
 Lcd_Out(2,1,"TXD:");
 Lcd_Cmd(0xC6);
 Lcd_Chr_Cp(adc_value/1000+'0');
 Lcd_Chr_Cp(((adc_value/100)%10)+'0');
 Lcd_Chr_Cp(((adc_value/10)%10)+'0');
 Lcd_Chr_Cp((adc_value%10)+'0');
 Lcd_Out(1,11,"     ");
 ...
 Delay_ms(100);
#line 78 "G:/My Drive/Envision/PIC Microcontroller/MikroC/Three_Node_PIC16/First_node1/First_node1.c"
 }
}
